...
<body>
    ...
    <nav class="navbar navbar-expand-lg  navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <a href="beranda.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0 text-success"><i class="far fa-hospital me-3"></i><b>PUSKESMAS PORSEA</b></h1>
        </a>
        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/user/berandaa" class="nav-item nav-link active">Beranda</a>
                <a href="/user/artikel" class="nav-item nav-link">Articles</a>
                <a href="/user/poli" class="nav-item nav-link">Poli</a>
                <a href="/consultation" class="nav-item nav-link">Konsultasi</a>
