        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    ...
                    <p style="color: black;">(PITC) mengacu pada tes dan konseling HIV yang secara rutin direkomendasikan oleh penyedia
                        layanan kesehatan kepada orang-orang yang datang ke fasilitas perawatan kesehatan sebagai komponen standar perawatan medis.</p>
                </div>
            </div>
        </div>
