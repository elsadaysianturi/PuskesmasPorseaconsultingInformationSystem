        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    ...
                    <p style="color: black;">Kesehatan ibu dan anak (KIA) mengacu pada kesehatan ibu, bayi, anak, dan remaja. Ini juga mengacu pada profesi dalam kesehatan masyarakat yang berkomitmen
                        untuk mempromosikan status kesehatan dan tantangan masa depan dari populasi yang rentan
                    </p>
                </div>
            </div>
        </div>
