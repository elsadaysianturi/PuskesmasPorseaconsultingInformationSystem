        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="d-flex flex-column">
                    ...
                    <p style="color: black;">Pemeriksaan kesehatan umum yang  melibatkan riwayat kesehatan, pemeriksaan fisik (singkat atau lengkap) dan terkadang tes laboratorium.</p>
                </div>
            </div>
        </div>
