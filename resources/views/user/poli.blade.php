        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/pemeriksaan_umum"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/keluhan_pasien"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/pitc"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/ibu_anak"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/gigi_mulut"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-light rounded h-100 p-5">
                    ...
                    <a class="btn" href="/user/gizi"><i class="fa fa-plus text-success me-3"></i>Kunjungi</a>
                </div>
            </div>
        </div>
    </div>
