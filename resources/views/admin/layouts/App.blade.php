...
<body>
    ...
    <h1 class="m-0 text-success"><img class="img-fluid" src="{{asset('/img/logoPuskesmas.png')}}" alt="" height="40" width="40"> </i><b>PUSKESMAS PORSEA</b></h1>
        ...
        <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="/admin/beranda" class="nav-item nav-link active">Beranda</a>
                <a href="/admin/articles" class="nav-item nav-link">Articles</a>
                <a href="/admin/poly" class="nav-item nav-link">Poli</a>
                <a href="/admin/consultations" class="nav-item nav-link">Konsultasi</a>
                <a href="/admin/sarans" class="nav-item nav-link">saran</a>
            </div>
            &nbsp;&nbsp;&nbsp;
